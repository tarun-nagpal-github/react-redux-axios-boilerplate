                ...
                <ul className="nav navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown mr-30">
                        <a className="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <img src="assets/images/team/04.jpg" alt="Profile Icon" />
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                            <div className="dropdown-header">
                                <div className="media">
                                    <div className="media-body">
                                        <h5 className="mt-0 mb-0">Jane Doe</h5>
                                        <span>{window.localStorage.getItem('email') ? window.localStorage.getItem('email') : "protal.investor@mail.com"}</span>
                            ...
                            <a className="dropdown-item" href="#/my-profile"><i className="text-warning ti-user"></i>Profile</a>
                            <div className="dropdown-divider"></div>
